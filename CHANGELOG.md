...
* ![Feature](https://img.shields.io/badge/-feature-green) A partially applied method of `uconvert` is added: `uconvert(units, equivalence)` returns a function that converts its argument to `units` using `equivalence`. ([#26](https://github.com/sostock/UnitfulEquivalences.jl/pull/26))
